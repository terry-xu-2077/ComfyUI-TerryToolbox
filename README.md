...
新增 `Terry Toolbox / Text / Terry | H3 提示词编辑器`。
...
新增 `Terry Toolbox / Video / Terry | 视频对比`。
...
**Terry Toolbox** 是 Terry 的个人 ComfyUI 工具箱节点包。
...
`ComfyUI/custom_nodes/ComfyUI-TerryToolbox/`

然后重启 ComfyUI。

## 扩展约定

建议 Terry Toolbox 后续统一采用以下分类：
...
- `Terry Toolbox/Audio`
- `Terry Toolbox/Text`
- `Terry Toolbox/Workflow`
- `Terry Toolbox/Utility`
